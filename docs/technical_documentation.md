...
**ویژگی‌های اصلی**:
- فرم ورود اطلاعات نسخه
- اعتبارسنجی داده‌های ورودی
- نمایش نتایج پیش‌بینی
- نمایش نمودارهای شاخص ریسک
...
سیستم تشخیص تقلب پزشکی یک راه‌حل جامع و پیشرفته است که از تکنیک‌های یادگیری ماشین و تحلیل داده‌ها برای شناسایی تقلب در نسخه‌های پزشکی استفاده می‌کند. این سیستم شامل:

1. **API قدرتمند**: با معماری RESTful و قابلیت‌های پیشرفته
2. **Portal کاربرپسند**: با رابط کاربری مدرن و واکنش‌گرا
3. **مدل هوشمند**: بر اساس Isolation Forest برای تشخیص تقلب
4. **استخراج ویژگی‌های پیشرفته**: با 11 ویژگی مختلف
5. **امنیت بالا**: با اعتبارسنجی و پاکسازی داده‌ها
6. **مستندات کامل**: برای توسعه و نگهداری آسان

این سیستم قابلیت مقیاس‌پذیری بالا و عملکرد بهینه را فراهم می‌کند و می‌تواند به عنوان یک ابزار قدرتمند برای تشخیص تقلب در حوزه پزشکی مورد استفاده قرار گیرد.
